...
(defun main ()
  ...
  (let ((lines (read-text-file (concatenate 'string file-root "data\\qa2_two-supporting-facts_test.txt"))))
    (let ((output (execute-task2 lines))
      ...
      ;; writes the output-str to output file.
      (write-text-file (concatenate 'string file-root "data\\qa2_two-supporting-facts_test.out") output-str)
      (write "output saved to data\\qa2_two-supporting-facts_test.out")
    )
  )
  ...
  (let ((lines (read-text-file (concatenate 'string file-root "data\\qa7_counting_test.txt"))))
    (let ((output (execute-task7 lines))
      ...
      (write-text-file (concatenate 'string file-root "data\\qa7_counting_test.out") output-str)
      (write "output saved to data\\qa7_counting_test.out")
    )
  )

  (let ((lines (read-text-file (concatenate 'string file-root "data\\qa8_lists-sets_test.txt"))))
    (let ((output (execute-task8 lines))
      ...
      (write-text-file (concatenate 'string file-root "data\\qa8_lists-sets_test.out") output-str)
      (write "output saved to data\\qa8_lists-sets_test.out")
    )
  )
  ...
  (let ((lines (read-text-file (concatenate 'string file-root "data\\qa10_indefinite-knowledge_test.txt"))))
    ...
    (output-str ""))
      ...
      (write-text-file (concatenate 'string file-root "data\\qa10_indefinite-knowledge_test.out") output-str)
      (write "output saved to data\\qa10_indefinite-knowledge_test.out")
    )
  )    

  (let ((lines (read-text-file (concatenate 'string file-root "data\\qa3_three-supporting-facts_test.txt"))))
    (let ((output (execute-task3 lines))
      ...
      (write-text-file (concatenate 'string file-root "data\\qa3_three-supporting-facts_test.out") output-str)
      (write "output saved to data\\qa3_three-supporting-facts_test.out")
    )
  )
)
